        ...
        <form name="form1" method="get" action="NetbookController">
            ...
            <div class="row mb-3">
                <label for="serienet" class="col-sm-2 col-form-label">Numero
                    Serie</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="serienet"
                        name="serienet">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="importado"
                        name="telefono">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="valor" name="valor"placeholder="0000000.00">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Registro
                    de Datos </label>
                <div class="col-sm-2">
